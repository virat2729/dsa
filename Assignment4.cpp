...
int main() {
    ...
    while(choice != 6) {
        ...
        cout << "2. Find the number of nodes in the longest path from the root / Height of Tree " << endl;
        ...
        switch(choice) {
            case 1:
                ...
                break;
            case 2:
                cout << "The number of nodes in the longest path from the root is (Height of Tree):  " << findHeight(root) << endl;
                break;
            case 3:
